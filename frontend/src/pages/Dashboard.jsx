        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl border border-white/20 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Link to="/knowledge-graph" className="block group">
                <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 hover:bg-white/10 transition-all">
                  <h3 className="text-xl font-semibold text-white mb-3">
                    Knowledge Graph
                  </h3>
                  ...
                  <div className="w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg transition-colors text-center">
                    Open Graph
                  </div>
                </div>
              </Link>
              ...
              <Link to="/assistant" className="block group">
                <div className="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6 hover:bg-white/10 transition-all">
                  ...
                  <div className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-lg transition-colors text-center">
                    Ask TRACE
                  </div>
                </div>
              </Link>
